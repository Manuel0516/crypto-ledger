...
class ManualConnector:
    ...
    pipeline as any other source so it's idempotent and auditable, but always
    marked REQUIRES_REVIEW until a person confirms it."""
    ...
    def normalize(self, raw: RawRecord) -> NormalizedEvent:
        ...
        return NormalizedEvent(
            ...
            source_label=payload.get("source_label", "Manual"),
