...
class _Event:
    ...
    __slots__ = (
        ...
        "sec_asset", "sec_amount", "at", "destination", "counterparty", "notes",
    ...
    def __init__(
        ...
        event_subtype=None, sec_asset=None, sec_amount=None, destination=None, counterparty=None,
        ...
        self.destination, self.counterparty, self.notes = destination, counterparty, notes
...
_EVENTS: list[_Event] = [
    ...
    _Event("bitget", "bg-wd-2024-02-10", "WITHDRAWAL", "-", "BTC", "0.20000000", "2024-02-10T11:00:00+00:00",
           destination="Cake Wallet · Bitcoin", counterparty="Me", fee_asset="BTC", fee_amount="0.00010000",
    ...
    _Event("binance", "bn-wd-2024-02-15", "WITHDRAWAL", "-", "ETH", "2.50000000", "2024-02-15T08:30:00+00:00",
           destination="MetaMask · Ethereum", counterparty="Me", fee_asset="ETH", fee_amount="0.00300000",
    ...
    _Event("binance", "bn-wd-2024-04-12", "WITHDRAWAL", "-", "SOL", "35.00000000", "2024-04-12T09:00:00+00:00",
           destination="Phantom · Solana", counterparty="Me", fee_asset="SOL", fee_amount="0.01000000",
    ...
    _Event("metamask", "mm-stake-2024-05-01", "STAKING_REWARD", "+", "ETH", "0.05000000", "2024-05-01T00:00:00+00:00",
           counterparty="Ethereum protocol", notes="ETH2 validator reward"),
    _Event("phantom", "ph-stake-2024-06-01", "STAKING_REWARD", "+", "SOL", "0.80000000", "2024-06-01T00:00:00+00:00",
           counterparty="Solana protocol", notes="Native SOL staking reward"),
    _Event("cake", "cake-pay-2024-06-15", "PAYMENT", "-", "BTC", "0.00500000", "2024-06-15T18:45:00+00:00",
           destination="Mullvad", counterparty="Mullvad", notes="Annual VPN subscription",
    ...
    _Event("metamask", "mm-airdrop-2025-03-15", "AIRDROP", "+", "UNI", "25.00000000", "2025-03-15T00:00:00+00:00",
           counterparty="Uniswap Foundation", notes="Governance token airdrop"),
    ...
    _Event("phantom", "ph-pay-2025-04-18", "PAYMENT", "-", "SOL", "3.00000000", "2025-04-18T20:10:00+00:00",
           destination="Steam", counterparty="Steam", notes="Game purchase"),
    ...
    _Event("binance", "bn-wd-2025-06-05", "WITHDRAWAL", "-", "SOL", "18.00000000", "2025-06-05T10:00:00+00:00",
           destination="Phantom · Solana", counterparty="Me", fee_asset="SOL", fee_amount="0.05000000",
    ...
    _Event("phantom", "ph-gift-2025-07-01", "GIFT_RECEIVED", "+", "SOL", "2.00000000", "2025-07-01T00:00:00+00:00",
           counterparty="Family member", notes="Gift received"),
    _Event("cake", "cake-pay-2025-07-10", "PAYMENT", "-", "BTC", "0.00300000", "2025-07-10T08:15:00+00:00",
           destination="Coffee Roasters", counterparty="Coffee Roasters", fee_asset="BTC", fee_amount="0.00005000"),
    ...
    _Event("binance", "bn-wd-2025-09-01", "WITHDRAWAL", "-", "ETH", "0.50000000", "2025-09-01T09:00:00+00:00",
           destination="MetaMask · Ethereum", counterparty="Me", fee_asset="ETH", fee_amount="0.00200000",
    ...
    _Event("phantom", "ph-wd-2025-10-10", "WITHDRAWAL", "-", "SOL", "15.00000000", "2025-10-10T13:00:00+00:00",
           destination="Binance", counterparty="Me", fee_asset="SOL", fee_amount="0.02000000",
    ...
    _Event("bitget", "bg-wd-2026-02-18", "WITHDRAWAL", "-", "BTC", "0.00600000", "2026-02-18T07:41:00+00:00",
           destination="Cake Wallet · Bitcoin", counterparty="Me", fee_asset="BTC", fee_amount="0.00001000",
    ...
    _Event("cake", "cake-pay-2026-03-01", "PAYMENT", "-", "BTC", "0.00020000", "2026-03-01T19:20:00+00:00",
           destination="Mullvad", counterparty="Mullvad", notes="Monthly service payment",
    ...
    _Event("metamask", "mm-wd-2026-06-01", "WITHDRAWAL", "-", "UNI", "10.00000000", "2026-06-01T12:00:00+00:00",
           destination="Binance", counterparty="Me", fee_asset="ETH", fee_amount="0.00200000",
...
_OVERRIDES = [
    ("cake-pay-2024-06-15", "counterparty", "", "Mullvad", "Added counterparty after reviewing the receipt", "2024-06-17T09:00:00+00:00"),
...
def _create_event(session: Session, planned: _Event, accounts: dict[str, Account]) -> Event:
    ...
    event = Event(
        ...
        destination_label=planned.destination,
        counterparty=planned.counterparty,
        notes=planned.notes,
        address_from=planned.address_from,
        address_to=planned.address_to,
        tx_hash=planned.tx_hash,
