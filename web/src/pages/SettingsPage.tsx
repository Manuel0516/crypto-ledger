...
function GeneralSection({ settings, save }: SectionProps) {
  ...
  useEffect(() => { setTheme(settings.ui_theme); setTimezone(settings.default_timezone); }, [settings.ui_theme, settings.default_timezone]);
